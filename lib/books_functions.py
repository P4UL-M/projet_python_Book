...
def add_book():
    ...
    with open(PATH / "books.txt", "r", encoding="utf-8") as books:
        ...
        if book_name not in [line[:-1] for line in books.readlines()]:
            with open(PATH / "books.txt", "a", encoding="utf-8") as books_write, open(PATH / "notes.txt", "r", encoding="utf-8") as notes:
...
def remove_books():
    with open(PATH / "books.txt", "r", encoding="utf-8") as books, open(PATH /"booksread.txt", "r", encoding="utf-8") as booksread, open(PATH / "notes.txt", "r", encoding="utf-8") as notes:
        ...
        if book_number_to_remove!= 0:    
            ...
            with open(PATH / "books.txt", "w", encoding="utf-8") as books_write:
...
def note_a_book():
    ...
    with open(PATH / "booksread.txt", "r", encoding="utf-8") as booksread, open(PATH / "books.txt", "r", encoding="utf-8") as books, open(PATH / "readers.txt", "r", encoding="utf-8") as readers :
        all_lines_booksread=booksread.readlines()
            ...
            while number_book!=0:
                if number_book not in all_lines_booksread[client_number].split(", "):
                    ...
                    if choice==1:
                        ...
                        number_book=ask_input("Enter the number of the book you want to note, 0 to exit : ", int, 0, maximum_number_book)
                        continue
                with open(PATH / "notes.txt", "r", encoding="utf-8") as notes:
                    final_notes=""
